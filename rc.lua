...
menu = require("./custom/widgets/menu")
...
awful.screen.connect_for_each_screen(function(s)
	...
	awful.tag({ "󰆍", "󰈹", "󰒱", "󰋩" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	awful.key(
		{ modkey, }, "w",
		function () menu:show({coords={ x = 0, y = 0 }}) end,
...
awful.rules.rules = {
	...
	-- Floating clients.
	{
		rule_any = {
			instance = {
				"btop",-- Includes session name in class.
				"pinentry",
			},
			class = {
				"Arandr",
	...
	{
		rule = { class = "firefox" },
		properties = { screen = 1, tag = "󰈹" }
	},
	{
		rule = { class = "Alacritty" },
		properties = { screen = 1, tag = "󰆍" }
	},
}
